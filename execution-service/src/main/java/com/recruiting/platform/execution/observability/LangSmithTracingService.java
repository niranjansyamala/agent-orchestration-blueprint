package com.recruiting.platform.execution.observability;
...
public class LangSmithTracingService {
    ...
    public LangSmithTracingService() {
        ...
        try {
            ...
            log.info("LangSmith tracing not configured; execution service will continue without remote traces");
